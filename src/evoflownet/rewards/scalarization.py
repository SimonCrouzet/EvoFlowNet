...
:class:`ScalarizedReward` is a :class:`~evoflownet.rewards.base.Reward` like any
    ...
    def scalarize(self, values: Fitness, preference: npt.ArrayLike) -> npt.NDArray[np.float64]:
        ...
        Args:
            values: An ``(n, n_objectives)`` array of objective values, as
                returned by :meth:`~evoflownet.landscapes.base.FitnessLandscape.evaluate`.
...
class ScalarizedReward(Reward):
    ...
    :meth:`log_reward`, because :class:`~evoflownet.rewards.base.Reward` takes
    ...
    Args:
        ...
        reward: The scalar reward applied to the combined value. Defaults to
            :class:`~evoflownet.rewards.base.TemperedReward`, which supplies the
    ...
    def scalar_reward(self) -> Reward:
        ...
        :meth:`~evoflownet.rewards.base.Reward.reward` is already the method that
