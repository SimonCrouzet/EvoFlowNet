...
useful convention here and matches :mod:`evoflownet.landscapes.gb1`, where 1.0
...
from evoflownet.data.cache import fetch
...
class TrpBLandscape(FitnessLandscape):
    ...
    :class:`~evoflownet.landscapes.gb1.GB1Landscape`.
